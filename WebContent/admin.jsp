...
<form style="margin: 0px; font-size: 36px;margin-left:108px;margin-right:-20px" name="form1" method="post" action="delete_shopowner.jsp">
              ...
              <input placeholder="   输入商家用户名进行删除" onClick="hideSearch()" type="text" name="ownid" id="search_text" style="background:url('img/search.png');background-repeat:no-repeat;background-position: 5px,center;">
...
<table width="90%" border="0" cellspacing="10" cellpadding="10">
    <tr>
        <td align="right" style="color:#ff0000;font-weight:bold;width: 390px;font-size:16px;">登录时间： </td>
        <td ><label><%=LogTime%></label>&nbsp;</td>
    </tr>
    <tr>
        <td align="right" style="color:#ff0000;font-weight:bold;width: 390px;font-size:16px;">ip地址： </td>
