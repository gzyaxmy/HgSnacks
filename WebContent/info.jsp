...
String sql1 = "select * from goods,carts where goods.gname=carts.gname and userid = '"
		+userid+"' group by ginfor order by COUNT(ginfor) desc limit 0,1";
...
<html>
  ...
  <body style="overflow:hidden;">
	...
	<table width="90%" border="0" cellspacing="10" cellpadding="10">
	  <tr>
	    <td align="right" style="color:#6495ED;font-weight:bold;font-size:16px;">姓名： </td>
	    <td ><label><%=username%></label>&nbsp;</td>
      </tr>
	  <tr>
	    <td align="right" style="color:#6495ED;font-weight:bold;font-size:16px;">性别：</td>
	    <td><label><%=usersex%></label>&nbsp;</td>
      </tr>
	  <tr>
	    <td align="right" style="color:#6495ED;font-weight:bold;font-size:16px;">电话： </td>
	    <td ><label><%=userphone%></label>&nbsp;</td>
      </tr>
	  <tr>
	    <td style="color:#6495ED;font-weight:bold;font-size:16px;" align="right">楼号： </td>
	    <td><label><%=userdormitory%></label>&nbsp;</td>
      </tr>
	  <tr>
	    <td align="right" style="color:#6495ED;font-weight:bold;font-size:16px;">宿舍号： </td>
	    <td ><label><%=usernumber%></label>&nbsp;</td>
      </tr>
		<tr>
			<td align="right" style="color:#6495ED;font-weight:bold;font-size:16px;">用户画像(主要购买类型)： </td>
			<td><label><%=huaxiang%></label>&nbsp;</td>
		</tr>
		<tr>
			<td align="right" style="color:#6495ED;font-weight:bold;font-size:16px;">登录时间： </td>
			<td ><label style="color:#F00";><%=LogTime%></label>&nbsp;</td>
		</tr>
		<tr>
			<td align="right" style="color:#6495ED;font-weight:bold;font-size:16px;">登录及退出的ip地址： </td>
