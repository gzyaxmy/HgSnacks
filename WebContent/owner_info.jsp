...
<html>
  ...
  <body style="overflow:hidden;">
	...
	<table width="90%" border="0" cellspacing="10" cellpadding="10">
	  <tr>
	    <td align="right" style="color:#ff6600;font-weight:bold;font-size:16px;">姓名： </td>
	  ...
	  <tr>
	    <td align="right" style="color:#ff6600;font-weight:bold;font-size:16px;">电话： </td>
	    <td><label><%=ownphone%></label>&nbsp;</td>
      </tr>
	  <tr>
	    <td align="right" style="color:#ff6600;font-weight:bold;font-size:16px;">楼号： </td>
	  ...
	  <tr>
		...
		<tr>
			<td align="right" style="color:#ff6600;font-weight:bold;font-size:16px;">登录时间： </td>
			<td ><label style="color:#000";><%=LogTime%></label>&nbsp;</td>
		</tr>
		<tr>
			<td align="right" style="color:#ff6600;font-weight:bold;font-size:16px;">登录及退出的ip地址： </td>
			<td ><label style="color:#000";><%=IP%></label>&nbsp;</td>
		</tr>
	  </table>
	<p>&nbsp;</p>
  </body>
